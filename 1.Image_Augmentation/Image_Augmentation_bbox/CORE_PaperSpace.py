...
class RandomScale(object):
    ...
    """
    def __init__(self, scale = 0.2, different_ratio = False):
        self.scale = scale
    ...
    def __call__(self, img, bboxes):
        ...
        img = canvas
        bboxes = clip_box(bboxes, [0,0,1 + img_shape[1], img_shape[0]], 0.50)
...
class RandomTranslate(object):
    ...
    def __call__(self, img, bboxes):        
        ...
        bboxes = clip_box(bboxes, [0,0,img_shape[1], img_shape[0]], 0.50)
...
class RandomRotate(object):
    ...
    def __call__(self, img, bboxes):
        ...
        bboxes = clip_box(bboxes, [0,0,w, h], 0.50)
